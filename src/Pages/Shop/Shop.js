        ...
        <div>
            ...
            <Grid container>
                <Grid item md="3" sm="12" xs="12">
                    <div>
                        <TextField id="outlined-basic" label="Search" variant="outlined" style={{"margin":"50px 0px 20px 5%"}}/>
                        {search != "" ? <ClearIcon onClick={() => resetToDefault()} /> : null}
                        <Button variant="contained" color="secondary" style={{ "marginTop": "60px", "borderRadius": "10px" }}><SearchIcon /></Button>
                    </div>
                    ...
                    <Button id="filter" variant="contained" color="secondary" style={{ "marginTop": "25px", "borderRadius": "10px" }}>Filter</Button>
                </Grid>
